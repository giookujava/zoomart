...
გთხოვ უფრო დეტალურად მომიყევი, ან აირჩიე ღილაკებიდან:"""
...
def handle(update):
    ...
    if text == "📞 ტექნიკოსი":
        ...
        send(chat_id,
            "📞 <b>ტექნიკოსთან დასაკავშირებლად დააჭირე:</b>\n\n"
            "<a href=\"https://t.me/g20goku\">👨‍🔧 ტექნიკოსი — @g20goku</a>\n\n"
            "პირდაპირ მიწერე პრობლემა!",
    ...
    if text == "❌ არა, ვერ მოაგვარა":
        ...
        notify_admin(name, chat_id, problem)
        send(chat_id,
            "⚠️ გასაგებია! პირდაპირ მიწერე ტექნიკოსს:\n\n"
            "<a href=\"https://t.me/g20goku\">👨‍🔧 ტექნიკოსი — @g20goku</a>",
            keyboard={"keyboard": [["🔄 თავიდან"]], "resize_keyboard": True}
        )
        return
